...
- The input JSON content should not contain any escaped UTF-16 characters (any `\uXXXX` sequences) as these are not yet supported by the parsing functionality.
