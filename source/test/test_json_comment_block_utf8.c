...
static tTestResult TestJsonCommentBlockUtf8Valid(void)
{
...
static tTestResult TestJsonCommentBlockUtf8Invalid(void)
{
	tTestResult TestResult = TEST_RESULT_INITIAL;
	tJsonElement Root;
	tJsonParse Parse;
...
static tTestResult TestJsonCommentBlockUtf8OutOfRange(void)
{
	tTestResult TestResult = TEST_RESULT_INITIAL;
	tJsonElement Root;
	tJsonParse Parse;
...
static tTestResult TestJsonCommentBlockUtf8Overlong(void)
{
	tTestResult TestResult = TEST_RESULT_INITIAL;
	tJsonElement Root;
	tJsonParse Parse;
