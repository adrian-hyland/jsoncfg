...
static tTestResult TestJsonParseContent(void)
{
	...
	static const tJsonUtf8Unit *InvalidContent[] =
	{
		...
		(const tJsonUtf8Unit *)"123 \"",
		(const tJsonUtf8Unit *)"123 ,",
		(const tJsonUtf8Unit *)"\"\\ux",
		(const tJsonUtf8Unit *)"\"\\u0x",
		(const tJsonUtf8Unit *)"\"\\u00x",
		(const tJsonUtf8Unit *)"\"\\u000x",
		(const tJsonUtf8Unit *)"\"\\uD800\\x",
		(const tJsonUtf8Unit *)"\"\\uD800\\ux",
		(const tJsonUtf8Unit *)"\"\\uD800\\uDx",
		(const tJsonUtf8Unit *)"\"\\uD800\\uDCx",
		(const tJsonUtf8Unit *)"\"\\uD800\\uDC0x",
		(const tJsonUtf8Unit *)"\"\\uD800\\uDB",
	};
	size_t n;
