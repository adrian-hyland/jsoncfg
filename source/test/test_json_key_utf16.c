...
static tTestResult TestJsonKeyUtf16Valid(void)
{
...
static const tTestCase TestCaseJsonKeyUtf16[] =
{
   { "Valid",   TestJsonKeyUtf16Valid  },
	{ "Invalid", TestJsonKeyUtf8Invalid }
};


const tTest TestJsonKeyUtf16 =
{
    "JsonKeyUtf16",
    TestCaseJsonKeyUtf16,
    sizeof(TestCaseJsonKeyUtf16) / sizeof(TestCaseJsonKeyUtf16[0])
};
