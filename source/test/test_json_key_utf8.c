...
static tTestResult TestJsonKeyUtf8Valid(void)
{
...
static tTestResult TestJsonKeyUtf8Invalid(void)
{
	tTestResult TestResult = TEST_RESULT_INITIAL;
	tJsonElement Root;
	tJsonParse Parse;
...
static tTestResult TestJsonKeyUtf8OutOfRange(void)
{
	tTestResult TestResult = TEST_RESULT_INITIAL;
	tJsonElement Root;
	tJsonParse Parse;
...
static tTestResult TestJsonKeyUtf8Overlong(void)
{
	tTestResult TestResult = TEST_RESULT_INITIAL;
	tJsonElement Root;
	tJsonParse Parse;
...
static const tTestCase TestCaseJsonKeyUtf8[] =
{
   { "Valid",      TestJsonKeyUtf8Valid      },
	{ "Invalid",    TestJsonKeyUtf8Invalid    },
	{ "OutOfRange", TestJsonKeyUtf8OutOfRange },
	{ "Overlong",   TestJsonKeyUtf8Overlong   }
};


const tTest TestJsonKeyUtf8 =
{
    "JsonKeyUtf8",
    TestCaseJsonKeyUtf8,
    sizeof(TestCaseJsonKeyUtf8) / sizeof(TestCaseJsonKeyUtf8[0])
};
