...
static bool TestJsonKeyUtf8Valid(void)
{
	tJsonElement Root;
	tJsonParse Parse;
	tJsonFormat Format;
...
static bool TestJsonKeyUtf8Invalid(void)
{
	tJsonElement Root;
	tJsonParse Parse;
	tJsonCharacter Character;
...
static bool TestJsonKeyUtf8OutOfRange(void)
{
	tJsonElement Root;
	tJsonParse Parse;
	tJsonCharacter Character;
...
static bool TestJsonKeyUtf8Overlong(void)
{
	tJsonElement Root;
	tJsonParse Parse;
	tJsonCharacter Character;
